...
const sidebarItems = [
  ...
  { icon: Zap, label: "Dispatch Board", href: "/dashboard/delivery/dispatch", permission: 'manage_delivery' },
  { icon: Truck, label: "Delivery Trips", href: "/dashboard/delivery/trips", permission: 'manage_delivery' },
  { icon: MessageSquare, label: "WhatsApp Logs", href: "/dashboard/delivery/whatsapp-logs", permission: 'manage_delivery' },
  { icon: MapPin, label: "Delivery Routes", href: "/dashboard/delivery/routes", permission: 'manage_delivery' },
  { icon: Layers, label: "Delivery Zones", href: "/dashboard/delivery/zones", permission: 'manage_delivery' },
