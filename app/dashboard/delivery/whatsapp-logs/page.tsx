...
export default function WhatsAppLogsPage() {
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-10 animate-in fade-in duration-700">
      ...
      <div className="bg-[#0F0F0F] rounded-2xl border border-white/5 overflow-hidden shadow-lg relative">
        {/* Operations Toolbar */}
        <div className="p-5 border-b border-white/5 bg-white/[0.01] flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="relative flex-1 w-full max-w-md">
             ...
             <input 
                ...
                className="w-full h-10 bg-black/40 border border-white/5 rounded-xl pl-10 pr-4 text-[10px] font-bold text-white uppercase tracking-widest focus:border-emerald-500/50 transition-all placeholder-[#555]"
             />
          </div>
          <p className="flex items-center gap-2 text-tertiary text-[10px] font-bold uppercase tracking-widest px-4 py-2 bg-white/5 rounded-xl border border-white/5">
          ...
          <table className="w-full text-left min-w-[900px]">
            <thead>
              <tr className="bg-white/[0.02]">
                <th className="px-10 py-8 text-[11px] font-black text-tertiary uppercase tracking-[0.3em] border-b border-white/5">Transmission Status</th>
                <th className="px-10 py-8 text-[11px] font-black text-tertiary uppercase tracking-[0.3em] border-b border-white/5">Recipient Unit</th>
                <th className="px-10 py-8 text-[11px] font-black text-tertiary uppercase tracking-[0.3em] border-b border-white/5">Signal Content</th>
                <th className="px-10 py-8 text-[11px] font-black text-tertiary uppercase tracking-[0.3em] border-b border-white/5">Timestamp</th>
                <th className="px-10 py-8 text-[11px] font-black text-tertiary uppercase tracking-[0.3em] border-b border-white/5">Payload Type</th>
              </tr>
            </thead>
              ...
              {filteredLogs.length === 0 ? (
                ...
                filteredLogs.map(log => (
                  <tr key={log.id} className="hover:bg-white/[0.02] transition-colors group">
                    ...
                    <td className="px-10 py-10 border-b border-white/[0.02]">
                      <Badge className="bg-white/5 text-tertiary border-white/10 uppercase text-[8px] font-black tracking-widest px-3 py-1 rounded-lg">
